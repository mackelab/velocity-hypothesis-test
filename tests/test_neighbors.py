...
def test_find_neighbors_in_direction_of_velocity_limited_neighborhoods(threshold_degree):
    print(f"--- Starting test_limited with threshold: {threshold_degree} ---")
    ...
    print(f"--- Finished test_limited with threshold: {threshold_degree} ---")
